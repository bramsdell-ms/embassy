...
mod inner_periph {
    ...
    embassy_hal_internal::peripherals!(
        ADC0,
        ADC1,
        // ADC2,  // not in MCXA577 PAC
        // ADC3,  // not in MCXA577 PAC
...
pub(crate) mod peripheral_gating {
    ...
    use crate::clocks::periph_helpers::{
        AdcConfig, CTimerConfig, Clk1MConfig, Lpi2cConfig, LpspiConfig, LpuartConfig, NoConfig, OsTimerConfig,
    };
    // use crate::clocks::periph_helpers::{
    ...
    // ADC2/ADC3 not present in MCXA577 PAC
